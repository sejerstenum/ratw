...
describe('App', () => {
  it('renders the iteration 3 headline with the new route table', () => {
    render(
      <MemoryRouter>
        <App />
      </MemoryRouter>,
    ...
    expect(
      screen.getByRole('heading', { name: /iteration 3 · inline route management/i }),
    ).toBeInTheDocument();
    ...
    expect(screen.getByRole('heading', { name: /route table/i })).toBeInTheDocument();

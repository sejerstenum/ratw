    ...
    <section className="mt-8 space-y-8">
      <header>
        ...
        <p className="mt-2 text-sm text-slate-300">
          A temporary interface to exercise the in-memory store behind the Route Table. Filter by leg
          and team, then add, update, and delete segments to verify ordering while experimenting with

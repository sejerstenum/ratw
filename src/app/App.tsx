    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        <section className="rounded-2xl border border-slate-800 bg-slate-900/40 p-8 shadow-lg shadow-slate-950/60">
          <h2 className="text-xl font-semibold">Iteration 2 · Legs & teams in sync</h2>
          <p className="mt-3 text-sm text-slate-300">
            The RATW tracker now layers leg filtering and team tabs on top of the in-memory segment store. Toggle the
            selection controls to explore how each team progresses through their current leg while keeping the URL in sync for
            easy sharing.
          </p>
          <div className="mt-6 grid gap-4 text-sm text-slate-200 sm:grid-cols-2">
            <div className="rounded-xl border border-slate-800/80 bg-slate-900/60 p-4">
              ...
              <ul className="mt-2 space-y-1 text-slate-300">
                <li>Leg selector that persists to the <code>?leg=</code> query parameter.</li>
                <li>Keyboard-friendly team tabs for quick context switching.</li>
                <li>Developer console filtered by the active team and leg.</li>
              </ul>
            </div>
            <div className="rounded-xl border border-slate-800/80 bg-slate-900/60 p-4">
              <h3 className="font-medium text-white">Up next</h3>
              <ul className="mt-2 space-y-1 text-slate-300">
                <li>Editable route table with inline validation.</li>
                <li>Visual timeline aligned with segment ordering.</li>
                <li>Autosave and persistence once editing lands.</li>
              </ul>
            </div>
          </div>
        </section>
